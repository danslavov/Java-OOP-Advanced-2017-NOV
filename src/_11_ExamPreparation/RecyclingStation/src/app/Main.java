...
import app.waste_disposal.ManagementRequirementImpl;
...
public class Main {
    public static void main(String[] args) {
        ...
        ManagementRequirement mr = new ManagementRequirementImpl();

        Engine engine = new Engine(
                reader, writer, garbageProcessor, balanceManager,
                wasteFactory, strategyFactory, mr
                );
        engine.run();
    }
}
